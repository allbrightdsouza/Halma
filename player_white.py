...
#                 eDist += euclid_dist(ePos, white_target_corner)
        ...
        baseScore = pbaseScore + ebaseScore 
    ...
    def set_game_time(self):
        ...
        if self.mode == 'SINGLE' :
            ...
            try :
                ...
                playtime = (self.time_left - 5.0) / 90.0 #divide remaining time needs to be modified to playerdata time
                file = open('./playdata.txt','w+')
...
#     print_board(halma.board_state)
    ...
    time_fail = sel_move,time_fail = halma.minimax(depth = 2) 
